...
import { Apple, Play, Flame, Handshake, CheckCircle2, TrendingUp } from "lucide-react";
...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #133A24 0%, #07150C 100%);
      box-shadow: 
  ...
  return (
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 tracking-tighter text-silver-matte">
          {ctaHeading}
        </h2>
        <p className="text-muted-foreground text-xl md:text-2xl lg:text-3xl mb-14 max-w-3xl mx-auto font-light leading-relaxed">
          {ctaDescription}
        </p>
        <div className="flex justify-center mt-4">
          <a href="#" aria-label="Shop Now" className="btn-modern-light flex items-center justify-center px-16 py-8 rounded-[2rem] group focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-offset-2">
            <div className="text-2xl md:text-3xl font-bold leading-none tracking-tight">Shop Now</div>
          </a>
        </div>
      </div>
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                {/* The Custom Intro Image */}
                <img
                  ref={mockupRef}
                  src="/intro.png"
                  alt="Thulira Intro"
                  className="w-[900px] md:w-[1200px] lg:w-[1500px] xl:w-[2200px] h-auto object-contain drop-shadow-2xl will-change-transform transform-style-3d"
                />
